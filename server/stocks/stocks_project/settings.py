...
SECRET_KEY = 'django-insecure-i0&bcash0u0as))se^-i@$&6!e2!%vyce#nn(y^mpt0)5m@0bo'
...
MIDDLEWARE = [
    ...
    'stocks_project.middleware.CSRFExemptMiddleware',  # 自定义CSRF豁免中间件
]
...
# 定义不需要CSRF验证的URL
CSRF_EXEMPT_URLS = ['/api/login/', '/api/register/', '/api/token/', '/api/token/refresh/']
